...
from chaos import mapper, exceptions, utils, db_helper, formatter
import chaos
import json
...
class DisruptionsHistory(flask_restful.Resource):
    ...
    def get(self, contributor, navitia, disruption_id):
        ...
        results = models.DisruptionHistory.get_by_public_id(disruption_id)

        disruptions = formatter.format_raw_disruption_history(results)
        ...
        return jsonify({'disruptions': disruptions.values()})
        ...
        #         'error': {'message': 'Disruption {} not found'.format(disruption_id)}
        #     }, error_fields), 404
        # rawData = {'disruptions': disruptions}
